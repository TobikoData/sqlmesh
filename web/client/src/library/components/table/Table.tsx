  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div
        ...
        className="w-full h-full rounded-lg overflow-auto scrollbar scrollbar--horizontal scrollbar--vertical"
      >
        <table
          cellPadding={0}
          cellSpacing={0}
...
function Footer({ count }: { count: number }): JSX.Element {
  return (
    <div className="text-neutral-700 dark:text-neutral-300 text-xs font-medium px-2 py-2">
