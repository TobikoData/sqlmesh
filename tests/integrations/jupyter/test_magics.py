...
def test_info(notebook, sushi_context, convert_all_html_output_to_text, get_all_html_output):
    ...
    assert get_all_html_output(output) == [
        ...
        '<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,\'DejaVu Sans Mono\',consolas,\'Courier New\',monospace">Connection:  concurrent_tasks: <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">1</span>  connector_config: <span style="font-weight: bold">{}</span>  extensions: <span style="font-weight: bold">[]</span>  pre_ping: false  register_comments: true  type: duckdb</pre>',
        "<pre style=\"white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace\"></pre>",
        '<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,\'DejaVu Sans Mono\',consolas,\'Courier New\',monospace">Test Connection:  concurrent_tasks: <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">1</span>  connector_config: <span style="font-weight: bold">{}</span>  extensions: <span style="font-weight: bold">[]</span>  pre_ping: false  register_comments: true  type: duckdb</pre>',
