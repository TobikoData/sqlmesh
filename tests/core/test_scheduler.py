...
def test_signals_and_lookback(mocker: MockerFixture, make_snapshot, get_batched_missing_intervals):
    @signal()
    ...
    assert batches == {
        ...
        b: [(to_timestamp("2023-01-01"), to_timestamp("2023-01-04"))],
        c: [(to_timestamp("2023-01-01"), to_timestamp("2023-01-02"))],
    }
