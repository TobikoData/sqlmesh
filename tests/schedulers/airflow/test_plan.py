...
from sqlmesh.core.model import create_sql_model, IncrementalByTimeRangeKind
...
def snapshot(make_snapshot, random_name) -> Snapshot:
    return make_snapshot(create_sql_model(random_name(), parse_one("SELECT 1, ds"), kind=IncrementalByTimeRangeKind()), version="1")
