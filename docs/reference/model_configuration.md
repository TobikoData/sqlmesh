...
| `post_create_kind`    | Custom create kinds cure (for engines supporting it, like `TEMPORARY` in Snowflake)                                                                                                                                                                                                                                                                         | str \| array[str] |    N     |
...
| `post_create_kind` | Custom create kinds cure (for engines supporting it, like `SECURE` in Snowflake)                     | str \| array[str] |    N     |
