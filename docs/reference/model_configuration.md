...
| `when_matched_exclude` | SQL logic used to not compare a column when determining which rows to update - only available on engines that support `MERGE`. (Default: compare all columns)                                                                                                                                                            | str \| array[str] | N        |
