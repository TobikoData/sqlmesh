...
| `high_water_mark_external_sensor_args` | The dictionary of arguments that will be passed into the high water mark external sensor during its construction.                                                                                               |          dict          |    N     |
