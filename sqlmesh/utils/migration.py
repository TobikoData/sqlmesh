...
MAX_TEXT_INDEX_LENGTH = {
    ...
    "doris": "250",  # Doris uses MySQL protocol, same 767 byte index size limit
...
def index_text_type(dialect: DialectType) -> str:
    """
    MySQL, Doris and MSSQL cannot create indexes or primary keys on TEXT fields; they
...
def blob_text_type(dialect: DialectType) -> str:
    return "LONGTEXT" if dialect in ("mysql", "doris") else "TEXT"
