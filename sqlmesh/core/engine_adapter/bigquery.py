...
class BigQueryEngineAdapter(EngineAdapter):
    ...
    def create_schema(self, schema_name: str, catalog_name: t.Optional[str] = None, ignore_if_exists: bool = True, warn_on_error: bool = True) -> None:
        """Create a schema from a name or qualified table name."""
        from google.api_core.exceptions import Conflict

        try:
            super().create_schema(
                schema_name, catalog_name=catalog_name, ignore_if_exists=ignore_if_exists, warn_on_error=False
            )
