...
try:
    from dbt.parser.sources import merge_source_freshness as merge_freshness  # type: ignore[attr-defined]
except ImportError:
    from dbt.parser.sources import merge_freshness  # type: ignore[no-redef,attr-defined]
